...
import { adminListNavigation, adminCreateNavItem, type NavigationInput } from "@/lib/cms";
...
export async function GET() {
  ...
  const navigation = await adminListNavigation();
...
export async function POST(request: NextRequest) {
  ...
  const id = await adminCreateNavItem(data);
